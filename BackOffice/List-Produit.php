                                ...
                                <tr>
                                    ...
                                    <td class="bo-td-center">
                                        <span class="bo-table-actions">
                                            <a href="Edit-Produit.php?id=<?php echo $produit['id_produit']; ?>" class="bo-img-link" title="Modifier" aria-label="Modifier"><img src="images/modify.png" width="22" height="22" alt=""></a>
                                            <a
