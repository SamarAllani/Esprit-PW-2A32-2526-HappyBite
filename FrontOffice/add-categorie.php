...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST["title"]) && isset($_POST["description"])) {
        if (!empty($_POST["title"])) {
            ...
            // Redirection vers la liste des catÃ©gories (Ã  crÃ©er)
...
<nav class="main-navbar">
    <div class="nav-container">
        ...
        <div class="nav-user">
            ...
            <a href="#" class="nav-action">SantÃ©</a>
                ...
                <div class="content mt-4">
                    ...
                    <form action="" method="POST">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="title" name="title" placeholder="Titre de la catÃ©gorie">
                        </div>
                        <div class="mb-3">
...
Content END -->
    ...
    <footer class="text-center py-3 mt-auto border-top small text-muted" style="font-family: Poppins, sans-serif;">
        © 2026 HappyBite
    </footer>
