...
class PostsPDF extends FPDF
{
    function Header()
    {
        ...
        // Use logo2.png (transparent background version)
        $logoPath = __DIR__ . '/../../Views/images/logo2.png';
        $fallback  = __DIR__ . '/../../Views/images/logo.png';
        $logo = file_exists($logoPath) ? $logoPath : (file_exists($fallback) ? $fallback : null);
