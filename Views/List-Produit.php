...
<main class="commande-wrap">
    <div class="liste-produits-stack">
        ...
        <div class="mode-buttons">
            <a href="?action=normal" class="btn-commande-outline<?php echo $action !== 'smart' ? ' is-active-mode' : ''; ?>">Tous les produits</a>
            <a href="?action=smart" class="btn-commande-primary<?php echo $action === 'smart' ? ' is-active-mode' : ''; ?>">Produits personnalisés</a>
        </div>
