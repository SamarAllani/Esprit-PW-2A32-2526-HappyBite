...
try {
    ...
    echo "<h2>🔧 Installation de l'administrateur</h2>";
    ...
    $db->exec("DELETE FROM utilisateur WHERE email = 'admin123@happybite.com'");
    $db->exec("DELETE FROM utilisateur WHERE email = 'admin123@happybite.com'");
    ...
    echo "<h3 style='color: #155724;'>✅ Administrateur créé avec succès !</h3>";
